...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Ibrahim & Dobaria Law LLC" },
      { property: "og:site_name", content: "Ibrahim & Dobaria Law LLC" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "Ibrahim & Dobaria Law LLC" },
      { property: "og:title", content: "Ibrahim & Dobaria Law LLC" },
      { name: "twitter:title", content: "Ibrahim & Dobaria Law LLC" },
      { name: "description", content: "Gilded Justice is a premium single-page law firm website for Ibrahim & Dobaria Law LLC." },
      { property: "og:description", content: "Gilded Justice is a premium single-page law firm website for Ibrahim & Dobaria Law LLC." },
      { name: "twitter:description", content: "Gilded Justice is a premium single-page law firm website for Ibrahim & Dobaria Law LLC." },
